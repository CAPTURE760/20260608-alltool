...
const tools = [
  {
    ...
    items: [
      ...
      { name: 'URL 编解码', href: '/url', desc: 'encodeURI / encodeURIComponent' },
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {category.items.map((tool) => (
                <Link
                  key={tool.href}
                  href={tool.href}
                  className="block p-4 border rounded-lg hover:shadow-md transition-shadow bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700"
                >
